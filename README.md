...
We model student knowledge using interaction data (attempts, correctness) and quantify cross-topic transfer effects using [your methods
here — e.g. mixed-effects models, knowledge tracing, etc.].
